  ...
  const uploadResume = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your resume has been uploaded and analyzed. Your profile has been created!"
      });
          ...
          <Alert>
            ...
            <AlertDescription>
              ...
              <ul className="list-disc ml-5 mt-2 space-y-1 text-sm">
                ...
                <li>Enable intelligent job matching</li>
              </ul>
            </AlertDescription>
          </Alert>
          ...
          {isUploading && (
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground text-center">
                ...
                {uploadProgress >= 30 && uploadProgress < 70 && "Analyzing with AI..."}
                {uploadProgress >= 70 && "Creating your profile..."}
              </p>
            </div>
          )}
