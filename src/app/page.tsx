      ...
      <section className="relative w-full py-20 md:py-32 lg:py-40 flex items-center justify-center bg-gradient-to-br from-primary/10 via-background to-accent/10 overflow-hidden">
        <Container className="z-10 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-headline font-bold tracking-tight text-foreground">
            Revolutionize Your Recruitment with <span className="text-primary">AI Talent Stream</span>
          </h1>
          <p className="mt-6 text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            The intelligent platform designed to find, assess, and hire top talent faster and smarter than ever before. Leverage the power of AI to streamline your entire hiring process.
          </p>
          <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
            ...
            <Link href="/auth" passHref>
              <Button size="lg" variant="outline" className="w-full sm:w-auto shadow-lg hover:shadow-accent/30 transition-shadow">
                <LogIn className="mr-2 h-5 w-5" /> Existing User? Login
              </Button>
            </Link>
          </div>
        </Container>
        ...
        <Container>
          <div className="text-center mb-12">
            ...
            <p className="mt-3 text-md text-muted-foreground max-w-xl mx-auto">
              Discover features built to give you a competitive edge in talent acquisition.
            </p>
          </div>
      ...
      <section className="py-16 lg:py-24 bg-muted/40">
        <Container>
          <div className="text-center mb-12">
            ...
            <p className="mt-3 text-md text-muted-foreground max-w-xl mx-auto">
              Choose the plan that best suits your organization's size and recruitment goals.
            </p>
          </div>
       ...
       <section className="py-16 lg:py-24 bg-background">
        <Container className="text-center">
          ...
          <p className="mt-4 text-md text-muted-foreground max-w-2xl mx-auto">
            We are a passionate team of technologists and HR experts dedicated to making recruitment more efficient, effective, and equitable through the power of artificial intelligence. Our mission is to connect great companies with exceptional talent, seamlessly.
          </p>
