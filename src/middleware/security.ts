  ...
  return async (req: NextRequest, ...args: any[]): Promise<NextResponse> => {
    ...
    const securityHeaders = {
      ...
      'Content-Security-Policy': [
        ...
        "connect-src 'self' https://api.elevenlabs.io https://firestore.googleapis.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://ai-talent-stream.firebaseapp.com wss://api.elevenlabs.io",
        "media-src 'self' blob:",
        "object-src 'none'",
        "base-uri 'self'",
        "form-action 'self'"
